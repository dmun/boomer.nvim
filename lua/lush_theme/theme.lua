...
local theme = lush(function(injected_functions)
  ...
  return {
    ...
    FloatBorder    { fg = bg.li(60).de(70),bg = bg.da(40).de(10) },
    FloatTitle     { fg = FloatBorder.fg.li(30), bg = bg.da(40).de(10), bold = true },
    StatusLine     { bg = bg.li(80).de(80), fg = bg },
    StatusLineNC   { bg = StatusLine.bg.da(30), fg = bg },
    Tabline        { bg = StatusLine.bg.da(30) },
